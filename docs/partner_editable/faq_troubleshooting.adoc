...
** Log in to the Broker server node and check the Broker node install log in `/home/ec2-user/rocketmq-deploy/install.log`. You can submit an issue to the Quick Start GitHub https://github.com/aws-quickstart/quickstart-apache-rocketmq[repository] for assistance. Include the error log with your submission.
