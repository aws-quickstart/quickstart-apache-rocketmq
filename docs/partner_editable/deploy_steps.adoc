...
[cols=2*]
|===
^|https://fwd.aws/9dXW6[Deploy {partner-product-short-name} into a new VPC on AWS^]
...
^|https://fwd.aws/xnNG6[Deploy {partner-product-short-name} into an existing VPC on AWS^]
